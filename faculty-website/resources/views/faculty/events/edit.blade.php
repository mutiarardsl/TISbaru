...
@section('title', 'Edit Event Fakultas')
...
<div class="card shadow-sm">
    <div class="card-header bg-primary text-white">
        <h5 class="mb-0"><i class="fas fa-edit me-2"></i>Edit Event Fakultas</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('faculty.events.update', $event['id']) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
            ...
            <div class="d-flex justify-content-between mt-3">
                <a href="{{ route('faculty.events.show', $event['id']) }}" class="btn btn-secondary">
