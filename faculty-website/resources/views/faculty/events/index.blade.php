...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1>Event Fakultas MIPA</h1>
    @auth
    <a href="{{ route('faculty.events.create') }}" class="btn btn-success">
...
<div class="row">
    <div class="col-md-3 mb-4">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('faculty.events.index') }}" method="GET">
                    <div class="mb-3">
    ...
    <div class="col-md-9">
        ...
        <div class="row">
            @foreach($facultyEvents as $event)
                ...
                <div class="card event-card h-100 shadow-sm">
                    ...
                    <div class="card-footer bg-white border-top-0">
                        <div class="d-grid gap-2">
                            <a href="{{ route('faculty.events.show', $event['id']) }}" class="btn btn-primary">
                                <i class="fas fa-info-circle me-1"></i> Detail
                            </a>
                            @auth
                            <div class="btn-group">
                                <a href="{{ route('faculty.events.edit', $event['id']) }}" class="btn btn-warning">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <form action="{{ route('faculty.events.destroy', $event['id']) }}" method="POST">
                                @csrf
                                @method('DELETE')
        ...
        <div class="alert alert-info">
            <i class="fas fa-info-circle me-2"></i> Tidak ada event fakultas saat ini.
        </div>
        @endif
    </div>
</div>
