        ...
        <div class="row">
            <div class="col-md-8">
                <nav aria-label="breadcrumb" class="mb-3">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('faculty.events.index') }}">Event Fakultas</a>
                        </li>
                ...
                <div class="card border-primary mb-4">
                    ...
                    <div class="card-body">
                        @if(\Carbon\Carbon::now() < \Carbon\Carbon::parse($event['registration_deadline'] ??
                            ...
                            action="{{ route('faculty.events.register', $event['id']) }}" method="POST">
                            @csrf
                            <div class="mb-3">
                    ...
                    <div class="card-body">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex align-items-center">
                                ...
                                <span>Penyelenggara: Fakultas MIPA</span>
                            </li>
                            <li class="list-group-item d-flex align-items-center">
                            ...
                            <li class="list-group-item d-flex align-items-center">
                                ...
                                <span>Email: info@mipa.ac.id</span>
                            </li>
                        </ul>
                    </div>
                </div>
