...
@section('title', 'Tambah Event Universitas')
...
<div class="card shadow-sm">
    <div class="card-header bg-primary text-white">
        <h5 class="mb-0"><i class="fas fa-plus-circle me-2"></i>Tambah Event Universitas</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('university.events.store') }}" method="POST">
            @csrf
    </div>
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            <label for="end_datetime" class="form-label">Waktu Selesai <span class="text-danger">*</span></label>
    ...
    <div class="d-flex justify-content-between mt-3">
        <a href="{{ route('university.events.index') }}" class="btn btn-secondary">
